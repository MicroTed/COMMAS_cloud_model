...
#     print ("Time (s), Time (m), Total Electrical Energy, Change in Energy, IC Flash, -CG Flash, +CG Flash, Positive Charge, Negative Charge, Net Charge, Max |E|\n");
     print ("Time (s), Time (min:sec), Flash Type, Total Electrical Energy, Change in Energy, Percent Change in Energy, Phistart (MV), Phiref (MV), Deltaphi (MV), Vert. Dipole Mom., CG Charge,Chg transfer, Dipole midpoint/charge altitude, Neg. Chan. Len., Pos. chan len., Tot. Chan. Len., Neg. Chan. Area., Pos. chan Area., Tot. Chan. Area. \n");
