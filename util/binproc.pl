...
#  processes in time bins of whatever width. (set to 1 minute bins)
# Looks for the lines:
# $infile = 
...
#       }
     ...
     if ( $vhacw[$curbin] > 0 ) {
       $rimdens[$curbin] = $qhacw[$curbin]/$vhacw[$curbin];
      } else {
       $rimdens[$curbin] = 0;
      }
...
#    print OUT ("Totals: ");
   ...
   for ($i = 1; $i < $curbin; $i++ ) {
    ...
    printf OUT ( "Totals:  %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e, %10.3e\n",
                $crfrzftot, $ciacrftot, $chcnshtot, $chcnihtot, $qhacwtot, $qracwtot, $qrcnwtot, $vhacwtot, $ptemtot, $pcondtot, $chmul1tot,  $csplintertot,  $qrfrzftot,  $qiacrftot,  $crcnwtot, $crmltshdtot ); 
    if ( $ion == 0 ) {
    ...
    print OUT ( "Time (min),crfrzf,ciacrf,chcnsh,chcnih,qhacw,qracw,qrcnw,vhacw,ptem,pcond,chmul1,csplinter,qrfrzf,",
                "qiacrf,crcnw,crmltshd,crfrz+ciarcr,qrfrzf+qiacrf,Rime Density,chcnsh+chcnih,chmul1+csplinter\n" );
     }
   for ($i = 1; $i < $curbin; $i++ ) {
    printf OUT ( "%03d, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e\n",
#    printf OUT ( "%03d, %3d, %7.2f, %3d, %3d, %3d, %8.3f, % 8.3f, % 8.3f, % 8.3f, % 8.3f, % 8.3f, % 8.3f, % 8.3f, % 8.3f, %5.2f, %5.2f, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %e, %9d, %9d, %9d, %e, %e\n",
      $bintime[$i],  $crfrzf[$i], $ciacrf[$i],  $chcnsh[$i], $chcnih[$i],  $qhacw[$i],  $qracw[$i],  $qrcnw[$i], 
       $vhacw[$i],  $ptem[$i], $pcond[$i], $chmul1[$i],  $csplinter[$i],  $qrfrzf[$i],$qiacrf[$i],  $crcnw[$i],  $crmltshd[$i],
       $crfrzf[$i]+$ciacrf[$i],$qrfrzf[$i]+$qiacrf[$i], $rimdens[$i], $chcnsh[$i]+$chcnih[$i], $chmul1[$i]+$csplinter[$i] );
